...
AI Overview
The core purpose is defining a detailed, high-fidelity React/Tailwind cinematic landing page builder with GSAP animations across seven distinct component architectures.
